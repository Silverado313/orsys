...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function initializeApp() {
        ...
        const previewPaymentHead = document.getElementById('preview-paymentHead');
        ...
        function updateReceiptPreview() {
            ...
            previewPaymentHead.textContent = document.getElementById('paymentHead').value || '-';
        ...
        function submitVoucher() {
            ...
            const paymentHead = document.getElementById('paymentHead').value;
            ...
            db.collection("dr.vouchers").add(voucher)
                .then((docRef) => {
            ...
            // ✅ Just add this one line after save:
            showPrintPopup(voucher.slipNo);                
        }
