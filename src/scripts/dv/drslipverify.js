        document.addEventListener('DOMContentLoaded', function() {
            ...
            function displayReceiptDetails(voucher) {
                ...
                document.getElementById('result-pointPerson2').textContent = voucher.pointPerson;
                ...
                document.getElementById('result-paymentHead').textContent = voucher.paymentHead;
                document.getElementById('result-user').textContent = voucher.user.charAt(0).toUpperCase() + voucher.user.slice(1);
