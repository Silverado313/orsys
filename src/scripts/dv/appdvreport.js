...
function displayUserInfo(user) {
    ...
    function generateReport() {
        ...
        // Build query
        let query = db.collection("dr.vouchers")
    ...
    function initializeDataTable() {     
        ...
        reportTable = $('#report-table').DataTable({
            ...
            buttons: [
                {
                    extend: 'excel',
                    filename: 'Report_CPV_' + dateFromFile + '_to_' + dateToFile
                },
                'print'
            ],
            pageLength: 25,
        ...
        reportData.forEach(item => {
            reportTable.row.add([
                ...
                // item.remarks,
                `<a onclick='window.open("/dv/dvprntview.html?slip=${item.slipNo}", "_blank", "toolbar=yes,scrollbars=yes,resizable=yes,top=150,left=250,width=800,height=600")'; class="btn btn-info btn-sm">View</a>`,
